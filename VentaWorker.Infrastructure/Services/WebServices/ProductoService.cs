...
namespace VentaWorker.Infrastructure.Services.WebServices
{
    public class ProductoService : IProductoService
    {
        ...
        public async Task<bool> ActualizarProducto(Producto producto)
        {
            ...
            var entidadSerializada = JsonSerializer.Serialize(new { IdProducto = producto.IdProducto,Nombre=producto.Nombre, Stock=producto.Stock, 
                StockMinimo= producto.StockMinimo, PrecioUnitario=producto.PrecioUnitario,  IdCategoria  =producto.IdCategoria  });
